#pragma once
// F16AeroStatePubSubTypes.hpp
#include <fastdds/dds/topic/TopicDataType.hpp>
#include <fastdds/rtps/common/InstanceHandle.hpp>
#include <fastdds/rtps/common/SerializedPayload.hpp>
#include "F16AeroState.hpp"

class F16AeroStatePubSubType : public eprosima::fastdds::dds::TopicDataType {
public:
  using type = F16AeroState;

  F16AeroStatePubSubType();
  ~F16AeroStatePubSubType() override;
